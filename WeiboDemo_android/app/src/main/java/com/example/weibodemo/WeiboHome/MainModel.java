...
public class MainModel {
    ...
    void requestList(RequestResult requestResult) {
        ...
        Call<WeiboContent> call = mainListRequest_interface.getList("2.00ZJoCFCadEPxBdf6e733c1aU7mwCD","60");//WeiboAccount.getInstance().getAccess_token()
...
interface MainListRequest_Interface {
    ...
    Call<WeiboContent> getList(@Query("access_token") String token,@Query("count") String count);
}
