...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../../flutter_module_weibo_login/.ios/Flutter/engine/Flutter.framework"
  install_framework "${PODS_ROOT}/../../flutter_module_weibo_login/.ios/Flutter/App.framework"
